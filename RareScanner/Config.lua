...
private.ITEM_CLASSES = {
	[Enum.ItemClass.Consumable] = { 0 }, --consumables
	[Enum.ItemClass.Container] = { 0, 1, 2, 3, 4 }, --bags
...
local DEFAULT_CONTINENT_MAP_ID = 1415
...
local getZoneName = function(zoneID)
	...
	elseif (private.DUNGEONS_IDS[zoneID]) then
		return LB[private.DUNGEONS_IDS[zoneID]]
	end
end
